...
/**
 * Class to handle shipping carriers and rates
 */
    ...
    public function get_shipping_rates($from_country, $from_zip, $to_country, $to_zip, $packages, $sort_by = 'totalPrice') {
        ...
        foreach ($response as $rate) {
            $shipping_rates[] = array(
                ...
                'serviceInfo' => isset($rate['service_info']) ? $rate['service_info'] : array(),
                'availableDates' => isset($rate['available_dates']) ? $rate['available_dates'] : array()
            );
        }
