    ...
    <form id="packlink-custom-shipping-form">
        ...
        <div class="form-section" id="details-section">
            ...
            <div class="contact-options">
                <label class="contact-connect-option">
                    <input type="checkbox" id="connect-contacts" checked>
                    <span class="contact-connect-text"><?php _e('Connect contacts (recipient of one route becomes sender of next)', 'packlink-custom-shipping'); ?></span>
                </label>
            </div>
        ...
        <div class="form-section" id="review-section">
            ...
            <div class="review-summary">
                ...
                <div class="review-item">
                    <h4><?php _e('Contact Information', 'packlink-custom-shipping'); ?></h4>
                    <div class="review-details">
                        <div class="review-column">
                            <h5><?php _e('Sender', 'packlink-custom-shipping'); ?></h5>
                            <p id="summary-sender-name"></p>
                            <p id="summary-sender-email"></p>
                            <p id="summary-sender-phone"></p>
                            <p id="summary-sender-company"></p>
                        </div>
                        <div class="review-column">
                            <h5><?php _e('Recipient', 'packlink-custom-shipping'); ?></h5>
                            <p id="summary-recipient-name"></p>
                            <p id="summary-recipient-email"></p>
                            <p id="summary-recipient-phone"></p>
                            <p id="summary-recipient-company"></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <template id="route-template">
        <div class="route-set" data-route-index="{ROUTE_INDEX}">
            ...
            <div class="form-grid">
                ...
                <div class="map-container map-container-{ROUTE_INDEX}">
                        <div class="route-map" id="map-{ROUTE_INDEX}" data-route-index="{ROUTE_INDEX}"></div>
                        <div class="map-overlay" id="route-info-{ROUTE_INDEX}">
                            <div class="route-type route-type-{ROUTE_INDEX}">
                                <div class="icon">
                                ...
                                <div class="details">
                                    <span class="label"><?php _e('Transport Type', 'packlink-custom-shipping'); ?></span>
                                    <span class="value"><?php _e('Road Transport', 'packlink-custom-shipping'); ?></span>
                                </div>
                            </div>
                            <div class="route-distance route-distance-{ROUTE_INDEX}">
                                <div class="icon">
                                ...
                                <div class="details">
                                    <span class="label"><?php _e('Distance', 'packlink-custom-shipping'); ?></span>
